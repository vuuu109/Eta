...
以上功能均可在模块自带配置界面中独立开关，切换即时生效。

## 配置界面

模块自带基于 [Miuix](https://github.com/compose-miuix-ui/miuix) 0.9.2 的设置界面，安装后桌面出现 FuckAndes 图标。所有开关默认开启，切换后通过 libxposed 的 RemotePreferences 跨进程同步到各 Hook 进程，即时生效，无需重启目标进程。
